...
using Sense.Crm.Modules.Marketing.Application.Members;
using Sense.Crm.Modules.Marketing.Application.Reports;
...
namespace Sense.Crm.Modules.Marketing.Api.Controllers;
