...
namespace Sense.Crm.Modules.Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920005512_TenantProfileCompletedAt")]
    partial class TenantProfileCompletedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sense.Crm.Modules.Identity.Domain.Memberships.Membership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sense.Crm.Modules.Identity.Domain.Roles.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sense.Crm.Modules.Identity.Domain.Tenants.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sense.Crm.Modules.Identity.Domain.Tokens.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sense.Crm.Modules.Identity.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sense.Crm.Modules.Identity.Domain.Memberships.Membership", b =>
                {
                    b.HasOne("Sense.Crm.Modules.Identity.Domain.Roles.Role", null)
                        .WithMany()
                    ...
                    b.HasOne("Sense.Crm.Modules.Identity.Domain.Tenants.Tenant", null)
                        .WithMany()
                    ...
                    b.HasOne("Sense.Crm.Modules.Identity.Domain.Users.User", null)
                        .WithMany()
