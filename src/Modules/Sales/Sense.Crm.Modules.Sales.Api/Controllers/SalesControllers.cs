...
using Sense.Crm.Modules.Sales.Application.Contacts;
using Sense.Crm.Modules.Sales.Application.Deals;
using Sense.Crm.Modules.Sales.Application.Leads;
using Sense.Crm.Modules.Sales.Application.Pipelines;
...
namespace Sense.Crm.Modules.Sales.Api.Controllers;
