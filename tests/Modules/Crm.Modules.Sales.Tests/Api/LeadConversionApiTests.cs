...
public sealed class LeadConversionApiTests(CrmApiFactory factory)
{
    ...
    {
        public Task<Crm.Modules.Sales.Domain.Deals.Deal?> GetByIdAsync(Guid id, CancellationToken ct) => throw new InvalidOperationException("boom");

        public void Add(Crm.Modules.Sales.Domain.Deals.Deal deal) => throw new InvalidOperationException("boom");

        public void Remove(Crm.Modules.Sales.Domain.Deals.Deal deal) => throw new InvalidOperationException("boom");
    }
}
