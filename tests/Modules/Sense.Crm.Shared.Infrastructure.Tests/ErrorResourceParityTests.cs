...
namespace Sense.Crm.Shared.Infrastructure.Tests;
...
public sealed class ErrorResourceParityTests
{
    ...
    public void SharedResource_TR_And_EN_HaveSameKeys()
    {
        ...
        var trPath = Path.Combine(repoRoot, "src/Shared/Sense.Crm.Shared.Infrastructure/Resources/SharedResource.resx");
        var enPath = Path.Combine(repoRoot, "src/Shared/Sense.Crm.Shared.Infrastructure/Resources/SharedResource.en.resx");
