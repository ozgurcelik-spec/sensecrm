...
public sealed class TenantIsolationConventionTests
{
    ...
    {
        // Arrange
        var moduleDbContextBaseType = Type.GetType("Sense.Crm.Shared.Infrastructure.Persistence.ModuleDbContext, Sense.Crm.Shared.Infrastructure");
    ...
    {
        // Arrange & Act
        var tenantContextType = typeof(Sense.Crm.Shared.Contracts.Context.ITenantContext);
