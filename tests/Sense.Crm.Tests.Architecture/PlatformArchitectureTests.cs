...
public sealed class PlatformArchitectureTests
{
    ...
    public void EveryBusinessModule_HasExactlyOneUsageReporter_WhoseModuleMatchesTheModuleName()
    {
        ...
        modules.Count.ShouldBeGreaterThanOrEqualTo(8, "ModuleCatalog'daki iş modülleri: identity, sales, activities, workflows, marketing, commerce, service, integrations (sayı sabitlenmez)");
